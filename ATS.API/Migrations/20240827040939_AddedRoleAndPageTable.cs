...
{
    /// <inheritdoc />
    public partial class AddedRoleAndPageTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "GetStatusOfAttendanceLog",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GetStatusOfAttendanceLog", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PageCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
